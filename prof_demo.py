...
def train(model, criterion, optimizer, train_loader, test_loader, nepochs=25, device="cpu", modprint=1,
    ...
    if (args.tracefile):
        prof.export_chrome_trace(args.tracefile)
        print("Trace file [" + args.tracefile + "] generated!")
    else:
        print("No --tracefile argument, No tracefile generated!")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tracefile', type=str, default="", help='Generated Trace Json File by Profile')
